class WaveTwo extends Phaser.Scene{
    ...
    create(){
        ...
        document.getElementById('description').innerHTML = '<h2>WaveTwo.js</h2>'
    ...
    update(){
        ...
        if ((this.rabbitsGone == true && this.rabbitCounter >= 10) && this.pandasGone == true && this.pandaCounter >= 5){
            console.log("was everything true?");
                this.add.text(400, 300, "You must be the rabbit whisperer!\nPress Enter to continue!", {fontSize: 20}).setOrigin(0.5, 0.5)
